                ...
                allOf(withId(R.id.input_email),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                0)));
        appCompatEditText3.perform(scrollTo(), replaceText("aaa@gmail.com"), closeSoftKeyboard());
                ...
                allOf(withId(R.id.input_mobile),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                0)));
        appCompatEditText4.perform(scrollTo(), replaceText("0869981996"), closeSoftKeyboard());
